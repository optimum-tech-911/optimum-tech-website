...
const mergeEffectOptions = overrides => {
...
const Hyperspeed = ({ effectOptions = {} }) => {
  ...
  const resolvedOptions = useMemo(() => mergeEffectOptions(effectOptions), [effectOptions]);
  ...
  useEffect(() => {
    ...
    (function () {
      ...
      if (typeof options.distortion === 'string') {
        options.distortion =
          distortions[options.distortion] ?? distortions[DEFAULT_EFFECT_OPTIONS.distortion];
      }
      ...
      try {
        ...
        myApp
          .loadAssets()
          .then(() => { myApp.init(); if (options.onInit) options.onInit(); })
          .catch(() => { if (options.onInitError) options.onInitError(); });
      } catch {
        if (options.onInitError) options.onInitError();
      }
    })();
