    ...
    <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'bg-[#050505] text-white' : 'bg-[#F5F5F7] text-black'}`}>
      ...
      <main className="flex flex-1 items-center px-4 pb-16 pt-32 md:px-6">
        <section className={`mx-auto w-full max-w-4xl overflow-hidden rounded-[2.5rem] border p-8 text-center md:p-14 ${
          ...
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#007BFF]/15 text-[#007BFF]">
            <Search className="h-7 w-7" aria-hidden="true" />
          </div>
          <p className="mt-6 text-sm font-semibold uppercase tracking-[0.2em] text-[#007BFF]">Erreur 404</p>
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link to="/" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#007BFF] px-6 py-3 font-semibold text-white transition hover:bg-[#007BFF]/90">
